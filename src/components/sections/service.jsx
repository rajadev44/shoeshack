  ...
  return (
    <Container>
        ...
        <div className="flex flex-wrap justify-between gap-4 mt-8 md:mt-28 ">
            <div className="flex flex-col flex-wrap p-5 space-y-2 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground">
            ...
            <div className="flex flex-col flex-wrap p-5 space-y-2 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground">
                ...
                <h2 className="text-xl font-semibold lining-nums">24/7</h2>
                <p className="text-sm text-muted ">Description goes here, tagline goes here..</p>
            </div>
            <div className="flex flex-col flex-wrap p-5 space-y-2 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground">
