  ...
  return (
    <Container>
        ...
        <div className="flex flex-wrap justify-between gap-4 mt-8 md:mt-28 ">
            <div className="flex flex-col p-5 space-y-4 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground">
                <Truck className="w-[1em] h-[1em] text-7xl" />
                <h2 className="text-4xl font-medium">Free Shipping</h2>
                <p className="text-muted">Description goes here, tagline goes here..</p>
            </div>
            <div className="flex flex-col p-5 space-y-4 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground">
                <svg  className={`w-[1em] h-[1em] text-7xl`}  width="82" height="67" viewBox="0 0 82 67" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col p-5 space-y-4 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground">
                <Headset className="w-[1em] h-[1em] text-7xl" />
