  ...
  return (
    <Container>
        ...
        <div className="flex flex-wrap justify-between gap-4 mt-8 md:mt-28 ">
            <div className="flex flex-col flex-wrap items-center p-5 space-y-2 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground md:items-start">
                <Truck className="w-[1em] mb-4 h-[1em] text-7xl" />
                <h2 className="text-xl font-semibold ">Fast Shipping</h2>
                <p className="text-sm text-muted ">Exclusive shipping to your doorway</p>
            </div>
            <div className="flex flex-col flex-wrap items-center p-5 space-y-2 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground md:items-start">
                <svg  className={`w-[1em] mb-4 h-[1em] text-7xl`}  width="82" height="67" viewBox="0 0 82 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h2 className="text-xl font-semibold lining-nums">24/7 Support</h2>
                <p className="text-sm text-muted ">Always available to help with your queries</p>
            </div>
            <div className="flex flex-col flex-wrap items-center p-5 space-y-2 rounded-sm grow lg:basis-1/4 bg-primary text-primary-foreground md:items-start">
                <Headset className="w-[1em] mb-4 h-[1em] text-7xl" />
                <h2 className="text-xl font-semibold ">Customer Support</h2>
                <p className="text-sm text-muted ">Our support agents are always willing to help you.</p>
            </div>
        </div>
